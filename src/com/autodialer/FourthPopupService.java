...
public class FourthPopupService extends Service {
	 DatabaseHandler dbcali;
	  private int result = Activity.RESULT_CANCELED;
	  public static final String FILEPATH = "filepathtwo";
	  public static final String RESULT = "result";
	  public static final String NOTIFICATION = "com.autodialer.FourthPopupService";

	public FourthPopupService() {
	//	 super("Like Service");
	}
 ...
 //Toast.makeText(getApplicationContext(), " Service Started", Toast.LENGTH_LONG).show();
  ...
  ArrayList<Contact> contact_array_from_db = dbcali.Get_Contacts();
	// if(contact_array_from_db.size() > 0){
	 ...
	 int text = contact_array_from_db.get(3).getID();
  ...
  params.put("num",""+text);
	...
	CustomRequest request = new CustomRequest(Request.Method.POST, "http://www.globegokartshows.co.ke/Testing/status/popup_status.php", params,
