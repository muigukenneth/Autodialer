...
public class CheckOfflineStatus extends Service {
	  private int result = Activity.RESULT_CANCELED;
	  public static final String FILEPATH = "filepathtwo";
	  public static final String RESULT = "result";
	  public static final String NOTIFICATION = "com.samir.UnlikeService";
...
public void onCreate() {
   ...
   user = db.getUserDetails();
	...
	CustomRequest request = new CustomRequest(Request.Method.POST, "http://www.globegokartshows.co.ke/Testing/status/offline_status.php", params,
